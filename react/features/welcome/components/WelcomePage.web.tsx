...
class WelcomePage extends AbstractWelcomePage<IProps> {
    ...
    constructor(props: IProps) {
        ...
        this.state = {
            ...this.state,
            room: 'majapahit', // Set default value to Security1
            ...
            <div
                                    ...
                                    <form onSubmit = { this._onFormSubmit }>
                                        <select
                                            ...
                                            {securityOptions.map(security => (
                                                <option
                                                    key = { security }
                                                    value = { security.toLocaleLowerCase() }>
                                                    {security}
                                                </option>
                                            ))}
                                        </select>
                ...
                <div className = 'welcome-cards-container'>
                    <div className = 'welcome-card-column'>
                        <div className = 'welcome-tabs welcome-card welcome-card'>{this._renderTabs()}</div>
                        {showAdditionalCard ? (
                            <div
