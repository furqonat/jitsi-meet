...
const Prejoin: React.FC<IPrejoinProps> = ({ navigation }: IPrejoinProps) => {
    ...
    const { showHangUp: showHangUpPrejoin = true } = useSelector(
        (state: IReduxState) => state["features/base/config"].prejoinConfig || {}
    );
    ...
    return (
        <JitsiScreen addBottomPadding={false} safeAreaInsets={["right"]} style={styles.contentWrapper}>
